# 🎓 Bibliometric Analysis Course - Project Summary
...
│
├── 📄 index.html                          # ⭐ MAIN COURSE - Open this first!
...
│   ├── biblioshiny_scripts/
│   │   └── complete_analysis_template.R   # Full R analysis workflow
│   ├── vosviewer_guides/
│   └── paper_templates/
│
...
└── 📁 resources/                          # Reference materials
    ├── cheat_sheets/
    │   └── biblioshiny_quick_reference.md # Quick reference guide
...
✅ Understand bibliometric analysis fundamentals
✅ Design effective search queries
✅ Collect high-quality bibliographic data
✅ Perform comprehensive analysis in R Biblioshiny
✅ Create professional network visualizations
✅ Interpret bibliometric results correctly
✅ Write and publish a bibliometric paper
...
```
outputs/
├── tables/          # CSV files with statistics
├── plots/           # PNG images for your paper
├── networks/        # Network analysis data
└── [additional files]
```
...
### Resources
- 📖 [R Bibliometrix Documentation](https://www.bibliometrix.org)
- 📖 [VOSviewer Manual](https://www.vosviewer.com/documentation/Manual_VOSviewer_1.6.18.pdf)
- 💬 [GitHub Issues](https://github.com/mahbubchula/Bibliometric-Analysis-by-Mahbub/issues)

### Contact
📧 mahbub.hassan@ieee.org
📧 6870376421@student.chula.ac.th
💻 github.com/mahbubchula
...
- 💻 Full R analysis template
- 🎨 Beautiful Chula-themed UI
